...
st.set_page_config(page_title="Order Queue", page_icon=":coffee:", layout="centered")

pane_height = 600
pending_container = st.container(height=pane_height, width="stretch", border=False)
